...
| ch4_N24_L8_e0.2_r0_q1_g1_1.json | kb_spectral_q, two traders, **as published (cascade defect)** | `kb_spectral_q 24 8 0.2 0 1 "1;1" --uniform 41` |
| ch4_NT2_N48.json | kb_spectral_q, two traders, as published | `kb_spectral_q 48 8 0.2 0 1 "1;1"` |
| ch4_fixed_cpp_NT2_N64_e0.001.json | kb_spectral with the cascade patch (patches/) | `kb_spectral 64 8 0.001 0 "1,1" --eps-path 0.2,0.05,0.01,0.003,0.001 --uniform 101` |
