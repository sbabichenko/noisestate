...
def test_detection():
    ...
    assert find_cyclic_symmetry(ns.load("examples/ch3_two_player.yaml")) is None                 # no ties
    d = ns.read_yaml("examples/ch3_two_player.yaml"); d["params"]["p2"] = d["params"]["p1"]; d["params"]["r2"] = d["params"]["r1"]; d["ties"] = [["player1", "player2"]]
