...
| test_transition_examples.py::test_ch3_precision_change_example | examples/ch3_precision_change.yaml's excess costs and settled (the T = 9 values stay fast in test_transition_result; the solve is in the baseline) | 9 |
